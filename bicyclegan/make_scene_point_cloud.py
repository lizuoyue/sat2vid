...
if __name__ == '__main__':
    ...
    for file in tqdm.tqdm(files):
        ...
        np.savez_compressed(f'london_15_frames_pc_npz/{fid}.npz',
        ...
        # write_point_cloud(f'syn_pc/{fid}_rgb.txt', pc[:, :6])
        # write_point_cloud(f'syn_pc/{fid}_sem.txt', np.hstack([
        #     pc[:, :3],
