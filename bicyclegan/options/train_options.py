...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--display_env', type=str, default='newhybrid_att6', help='visdom display environment name (default is "main")')
        ...
        parser.add_argument('--save_iter_freq', type=int, default=1000, help='frequency of saving the latest results')
